...
public class ParameterConstructor {
    ...
    public <T> T askParameter(BuildingRequest<T> buildingRequest) throws
        ...
        do {
            ...
            if (buildingRequest.validation()!=null && buildingRequest.validation().test(x)) next = false;
            else System.out.println("error");

            } catch (DateTimeParseException e) {
                System.out.println("Ошибка ввода даты. Пожалуйста, введите дату в правильном формате.");
            } catch (IllegalArgumentException e) {
                System.out.println("Неправильный формат аргумента, повторите ввод" + e.getMessage());
