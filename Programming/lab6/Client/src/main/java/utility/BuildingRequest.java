...
/**
 * A record class to create a request for building a field of {@link model.Worker}
...
public record BuildingRequest<T>(AbstractParser<T> parser, Predicate<T> validation, String message) {
    ...
    /**
     * Creates request for building a field of {@link model.Worker} if it has not any constraints
     *
